...
public class PayAdNavPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        payrollManagementButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        payrollManagementButton.setText("Payroll");
        jPanel1.add(payrollManagementButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 410, 140, -1));

        employeeManagementButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        employeeManagementButton.setText("Employee");
        jPanel1.add(employeeManagementButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 445, 140, -1));

        leaveManagementButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        leaveManagementButton.setText("Leave");
        jPanel1.add(leaveManagementButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 140, -1));
